...
echo "[$(date '+%Y-%m-%d %H:%M:%S')] GhostGMS Uninstall started" > /data/local/tmp/ghostgms_uninstall.log
...
# Re-enable all GMS services from gmslist.txt
...
echo "All GMS services re-enabled and settings restored" >> /data/local/tmp/ghostgms_uninstall.log
